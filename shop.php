...
#dv1 {
    ...
    padding: 2px;
animation:dv1 5s 1;
-moz-animation:dv1 5s 1;
-webkit-animation:dv1 5s 1;
-o-animation:dv1 5s 1;
border-radius:5px;
...
{
  .product-sorting-wrapper .product-show{
      float: none;
   }
...
<div class="breadcrumb-area gray-bg">
            <div class="container">
                <div class="breadcrumb-content" id="dv1">
                    <ul>
