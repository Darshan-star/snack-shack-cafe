...
<html lang="en">
   <head>
      ...
      <title>Snack Shack || Order Master</title>
            ...
            <div class="main-panel" style="width:100%;">
               ...
               <footer class="footer">
                  <div class="d-sm-flex justify-content-center justify-content-sm-between">
                     <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2023 <a href="https://www.linkedin.com/in/darshan-yadav-9496b0201/" target="_blank">Snack Shack Cafe</a>. All rights reserved.</span>
                  </div>
               </footer>
               <!-- partial -->
            </div>
